import type { SessionMeta, TimelineEvent, TopicInfo, LogItem, KGraphData, ChatMessage } from '@shared/types'
...
export const MOCK_CHAT_MESSAGES: ChatMessage[] = [
  { id: 'sys-1', role: 'system', text: 'Session started · rosbag loaded · 14:32 PT' },
  {
    id: 'msg-1',
    role: 'assistant',
    time: '14:32',
  ...
  { id: 'msg-2', role: 'user', text: 'Why did robot-12 stop near loading bay 3?' },
  {
    id: 'msg-3',
    role: 'assistant',
    time: '14:33',
    ...
    plan: [
      ...
      { label: 'Cross-reference /diagnostics + /sensors', done: true, active: false },
  ...
  { id: 'sys-2', role: 'system', text: 'Comparing against baseline run-1024 — 4 more results pending' },
]
