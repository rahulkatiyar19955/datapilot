...
function formatSize(totalMessages: number): string {
  if (totalMessages > 10000)
    return `${(totalMessages / 1000).toFixed(0)}K msgs`;
  ...
  return (
    ...
    >
      ...
      <div className="row gap-2" style={{ flexWrap: "wrap" }}>
        ...
        <div
          className="pill"
          style={{ height: 26, padding: "0 4px 0 10px", gap: 8 }}
        >
          <Icon.File size={11} />
        ...
        <div className="pill ghost mono" style={{ fontSize: 10.5 }}>
          {formatDuration(meta.durationSeconds)} duration · {meta.topicsCount}{" "}
          topics
        </div>
      </div>
    </div>
