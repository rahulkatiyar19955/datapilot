...
const TICKS = (total: number) =>
  Array.from(
    { length: Math.floor(total / TICK_INTERVAL) + 1 },
    (_, i) => i * TICK_INTERVAL,
  );
    ...
    <div className="col flex1" style={{ minHeight: 0 }}>
      ...
      >
        ...
        <button
          ...
          onClick={handleZoomToAnomalies}
          disabled={!timeline.some((e) => e.type === "anomaly")}
        >
          <Icon.Zoom size={12} />
          Zoom to anomalies
        </button>
      ...
      >
        <div
          className="row"
          style={{ alignItems: "flex-end", height: 30, gap: 2 }}
        >
      ...
      <div
        className="flex1"
        style={{ overflow: "auto", padding: "4px 14px 14px" }}
      >
        {/* Tick row */}
        <div
          style={{
        ...
        {selectedEvent && (
          ...
          >
            <div className="row gap-2" style={{ marginBottom: 8 }}>
              ...
              <span
                className="mono"
                style={{ fontSize: 11.5, color: "var(--color-text-1)" }}
              >
            ...
            <div className="dim" style={{ fontSize: 11.5, lineHeight: 1.5 }}>
              Click an adjacent event to see relationship · DataPilot suggested
              this is part of the failure chain.
            </div>
          </div>
        )}
      </div>
